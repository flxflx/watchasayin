...
namespace watchasayin.Surface
{
    ...
    /// </summary>
    /// <param name="participantHandle">The participant's handle.</param>
    /// <param name="id">The Id of the call.</param>
    /// <param name="outgoing">A flag indicating whether the call is outgoing or not.</param>
    public delegate void DCallStartedHandler(string participantHandle, int id, bool outgoing);
    ...
    /// <param name="participantHandle">The participant's handle.</param>
    /// <param name="id">The Id of the call.</param>
    public delegate void DCallEndedHandler(string participantHandle, int id);
    ...
    /// <summary>
    /// Definition of an VoIP/chat event dispatcher.
    /// </summary>
