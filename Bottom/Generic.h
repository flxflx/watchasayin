...
class ATL_NO_VTABLE CGeneric :
	...
	public IDispatchImpl<IGeneric, &IID_IGeneric, &LIBID_BottomLib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
public:
	CGeneric()
	{
...
public:
	...
	//! Gets the PID of the process the module is running in.
	STDMETHOD(getPid)(int* pid);
	//! Gets the log of the module.
	STDMETHOD(getLog)(SAFEARRAY* * lines);
	/*! 
		Requests the module to unload itself
		\param ownName The name of the module (e.g. Bottom.dll).
	*/
	STDMETHOD(unload)(BSTR ownName);
};
